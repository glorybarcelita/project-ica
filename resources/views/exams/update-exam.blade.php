        ...
        <div class="card-header">
         ...
         <div class="card-body">
            <form method="POST" action="{{ url('exams/update') }}">
              ...
              <input type="hidden" name="exam_id" value="{{ $questions->id}}">
              <div class="form-group row">
                    <label for="user-status" class="col-sm-2 col-form-label">Question</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="examquestion" placeholder="Add Question" required>{{ $questions->question }}</textarea>             
                    </div>
               </div>
