            ...
            <form method="POST" action="{{ route('subjects.update',['id'=> $subject->id]) }}">
                ...
                <label for="is_active" class="col-sm-2 col-form-label">Status</label>
                    <div class="col-sm-10">
                         <select id="is_active" name="is_active" class="form-control">
                            <option value="0" @if(!$subject->is_active) selected @endif>Inactive</option>
                            <option value="1" @if($subject->is_active) selected @endif>Active</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="" name="subjectname" value = "{{ old('subjectname') ?: $subject->name }}"  placeholder="Subject Name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="description" placeholder="Description">{{ old('description') ?: $subject->description }}</textarea>             
                    </div>
               </div>
