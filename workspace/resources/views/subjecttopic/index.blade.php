...
@section('content')
  ...
  <div class="container mt-4">
    ...
    <a href="{{ route('subjecttopic.create',['id' => $subjects->id]) }}" class="btn btn-md btn-info mt-3">Add Topic</a>
                ...
                <div class="col-sm-3">
                    <div class="card border-info my-3 mx-3" style="max-width: 20rem;">
                      <div class="card-header">
                        <h5><a href="{{ route('subjecttopic.show') }}" class="label text-info">aaaa</a></h5>
                      </div>
